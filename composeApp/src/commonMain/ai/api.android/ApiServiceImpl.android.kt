// androidMain/kotlin/com/example/network/ApiServiceImpl.android.kt
...
actual class ApiServiceImpl : ApiService {
    private val client = HttpClient {
        // Android-specific HttpClient configuration
        engine {
            // Android-specific engine configuration (OkHttp or other)
        }
    }
...
class AndroidApiUtils {
    fun getAndroidPlatformHeader(): String {
